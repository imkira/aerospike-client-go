...
const defaultMaxIdle = 14 * time.Second
...
type ClientPolicy struct {
	...
	// Maximum connection idle duration. Every time a connection is used, its
	// idle deadline will be extended by this duration. When this deadline is
	// reached, the connection will be closed and discarded from the pool.
	MaxIdle time.Duration //= 14 seconds
